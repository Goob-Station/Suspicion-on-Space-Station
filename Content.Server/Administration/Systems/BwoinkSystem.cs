...
namespace Content.Server.Administration.Systems
{
    ...
    public sealed partial class BwoinkSystem : SharedBwoinkSystem
    {
        ...
        private bool _ahelpAdminPrefix = false;
        ...
        public override void Initialize()
        {
            ...
            Subs.CVar(_config, CCVars.AhelpAdminPrefix, OnAhelpAdminPrefixChanged, true);
            Subs.CVar(_config, CCVars.UseAdminOOCColorInBwoinks, OnUseAdminOOCColorInBwoinksChanged, true);
            Subs.CVar(_config, CCVars.UseDiscordRoleColor, OnUseDiscordRoleColorChanged, true);
            Subs.CVar(_config, CCVars.UseDiscordRoleName, OnUseDiscordRoleNameChanged, true);
            Subs.CVar(_config, CCVars.DiscordReplyPrefix, OnDiscordReplyPrefixChanged, true);
            Subs.CVar(_config, CCVars.AdminBwoinkColor, OnAdminBwoinkColorChanged, true);
            Subs.CVar(_config, CCVars.DiscordReplyColor, OnDiscordReplyColorChanged, true);
        ...
        private void OnAhelpAdminPrefixChanged(bool newValue)
        {
            _ahelpAdminPrefix = newValue;
        }
