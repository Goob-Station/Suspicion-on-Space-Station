...
chat-manager-entity-say-wrap-message = [BubbleHeader][bold][Name]{$entityName}[/Name][/bold][/BubbleHeader][bold]:[/bold] [font={$fontType} size={$fontSize}][BubbleContent]{$message}[/BubbleContent][/font]
chat-manager-entity-say-bold-wrap-message = [BubbleHeader][bold][Name]{$entityName}[/Name][/bold][/BubbleHeader][bold]:[/bold] [font={$fontType} size={$fontSize}][BubbleContent][bold]{$message}[/bold][/BubbleContent][/font]

chat-manager-entity-whisper-wrap-message = [font size=11][italic][BubbleHeader][Name]{$entityName}[/Name][/BubbleHeader][bold]:[/bold] [BubbleContent]{$message}[/BubbleContent][/italic][/font]
chat-manager-entity-whisper-unknown-wrap-message = [font size=11][italic][BubbleHeader]Someone[/BubbleHeader][bold]:[/bold] [BubbleContent]{$message}[/BubbleContent][/italic][/font]
# SSS end
